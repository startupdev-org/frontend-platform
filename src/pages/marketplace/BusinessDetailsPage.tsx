...
export default function BusinessTestPage() {
  ...
  if (isLoading || !business) {
    if (isLoading) {
      return <PagePreloader active={true} />;
    }
    return (
  ...
  const workingHours = (() => {
    ...
    const source = (business as unknown as { working_hours?: Partial<WorkingHoursShape> }).working_hours;
    const raw = (business as unknown as { businessWorkingHours?: RawWorkingHoursItem[] }).businessWorkingHours;
                    ...
                    <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div className="rounded-xl border border-gray-200 bg-gray-50/50 p-5">
                        ...
                        <dl className="mt-4 space-y-2.5">
                          {(
                            [
                              ['Luni', 'monday', workingHours.monday],
                              ['Marți', 'tuesday', workingHours.tuesday],
                              ['Miercuri', 'wednesday', workingHours.wednesday],
                              ['Joi', 'thursday', workingHours.thursday],
                              ['Vineri', 'friday', workingHours.friday],
                              ['Sâmbătă', 'saturday', workingHours.saturday],
                              ['Duminică', 'sunday', workingHours.sunday],
                            ] as const
                          ).map(([label, key, h]) => {
